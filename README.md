...
## 安装使用说明
### 代码简单部署  
- 用idea打开[web01文件](https://github.com/yrDong/neu-javaweb/tree/main/web01)，使用maven内置的tomcat启动，[登陆界面http://localhost:8090/web01/html/userLogin.html](http://localhost:8090/web01/html/userLogin.html)
### 数据库脚本
- 执行[web01_sql脚本文件](https://github.com/yrDong/neu-javaweb/tree/main/web01_sql)
